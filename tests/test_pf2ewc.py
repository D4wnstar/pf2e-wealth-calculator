...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "longsword",
            1,
            pf.ItemInfo("longsword", pf.Money(gp=1), "weapons", 0, "common"),
        ),
        # Multi-word item
        (
            "composite longbow",
            2,
            pf.ItemInfo("composite longbow", pf.Money(gp=40), "weapons", 0, "common"),
        ),
        # Multi-word specific item
        (
            "storm flash",
            1,
            pf.ItemInfo("storm flash", pf.Money(gp=4000), "weapons", 14, "common"),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "25 gp", pf.Money(gp=25, origin="currency"), "currency", 0, "common"
            ),
        ),
        (
            "12 sp",
            4,
            pf.ItemInfo(
                "12 sp", pf.Money(sp=48, origin="currency"), "currency", 0, "common"
            ),
        ),
        # Uncommon rarity
        ...
        (
            "breastplate",
            1,
            pf.ItemInfo("breastplate", pf.Money(gp=8), "armor", 0, "common"),
        ),
        # Different category (adventuring gear)
        (
            "compass",
            1,
            pf.ItemInfo("compass", pf.Money(gp=1), "adventuring gear", 0, "common"),
        ),
        # Different category (alchemical items)
        (
            "flayleaf",
            1,
            pf.ItemInfo("flayleaf", pf.Money(gp=1), "alchemical items", 0, "common"),
        ),
        # Different category (animals and gear)
        (
            "rabbit",
            1,
            pf.ItemInfo("rabbit", pf.Money(gp=1), "animals and gear", 0, "common"),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "reinforced surcoat", pf.Money(gp=2), "adjustments", 0, "uncommon"
            ),
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            1,
            "armor",
            pf.ItemInfo("chain mail", pf.Money(gp=6), "armor", 0, "common"),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "silver shield (low-grade)", pf.Money(gp=34), "shields", 2, "common"
            ),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "silver buckler (low-grade)", pf.Money(gp=30), "shields", 2, "common"
            ),
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "+1 falchion",
            1,
            pf.ItemInfo("+1 falchion", pf.Money(gp=38), "weapons", 2, "common"),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "+1 striking greataxe", pf.Money(gp=102), "weapons", 4, "common"
            ),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "+1 striking hand adze", pf.Money(sp=5, gp=100), "weapons", 4, "common"
            ),
        ),
        ...
        (
            ...
            1,
            pf.ItemInfo(
                "+2 greater striking rapier", pf.Money(gp=2002), "weapons", 12, "common"
            ),
        ),
        # Multiple grades
        (
        ...
        (
            "+1 chain mail",
            1,
            pf.ItemInfo("+1 chain mail", pf.Money(gp=166), "armor", 5, "common"),
        ),
        # Multiple runes
        (
